...
public class EmployeeManagement {
    public static void main(String[] args){
        Employee e1 = new Employee("Dinesh Raghavendar", 121, "Software Engineer");
        Employee e2 = new Employee("Akshaya", 154, "DB Admin");
        Employee e3 = new Employee("Jason", 132, "Cloud Engineer");
